...
func New(config Config) (*Server, error) {
	...
	protected.HandleFunc("GET /api/kanban/sessions", server.listKanbanSessions)
	protected.HandleFunc("GET /api/kanban/archives", server.listKanbanArchives)
	protected.HandleFunc("PATCH /api/kanban/sessions/{terminalID}/{sessionID}", server.updateKanbanArchive)
